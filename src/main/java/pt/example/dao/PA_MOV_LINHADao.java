...
public class PA_MOV_LINHADao extends GenericDaoJpaImpl<PA_MOV_LINHA, Integer> implements GenericDao<PA_MOV_LINHA, Integer> {
	...
	public List<PA_MOV_LINHA> getbyid(Integer id) {
		...
		Query query = entityManager.createQuery("Select a, "
				+ "(select (select c.NOME_UTILIZADOR from GER_UTILIZADORES c where c.ID_UTILIZADOR =  b.UTZ_ENCAMINHADO) from GT_MOV_TAREFAS b where b.ID_MODULO = 13 and b.SUB_MODULO = 'PA' and b.ID_CAMPO = a.ID_PLANO_LINHA and b.ID_TAREFA_PAI is null), "
				+ "(select b.ID_TAREFA from GT_MOV_TAREFAS b where b.ID_MODULO = 13 and b.SUB_MODULO = 'PA' and b.ID_CAMPO = a.ID_PLANO_LINHA and b.ID_TAREFA_PAI is null) as ID_TAREFA "
