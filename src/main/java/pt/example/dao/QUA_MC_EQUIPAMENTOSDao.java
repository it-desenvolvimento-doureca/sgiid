...
public class QUA_MC_EQUIPAMENTOSDao extends GenericDaoJpaImpl<QUA_MC_EQUIPAMENTOS, Integer>
	...
	public List<Object[]> getlista() {
		String sql =
			...
			" CASE WHEN a.OBSOLETO = 0 AND a.CALIBR_EXTERNA = 1 AND (lcp_ext.DATA_CALIBRACAO IS NULL OR DATEADD(MONTH, a.INTERCALIB_EXT_MESES, lcp_ext.DATA_CALIBRACAO) < GETDATE()) THEN 1 ELSE 0 END AS C14 " +
