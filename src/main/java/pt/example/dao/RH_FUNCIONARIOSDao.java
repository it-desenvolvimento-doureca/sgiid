	...
	public List<RH_FUNCIONARIOS> getOperacoes(String data1, String data2, String Ativo, String Operario,
		...
		Query query = entityManager
				.createNativeQuery("DECLARE @DATA date = '" + data1 + "'; " + "DECLARE @DATA2 date = '" + data2 + "';  "
						...
						+ " CASE WHEN (TempoPausas = 0 or TempoPausas is null) and  TempoTotalPausa >0 THEN TempoTotal - TempoPausas + TempoTotalPausa ELSE TempoTotal END TempoTotal ,heudeb,heufin,ofnum,cadencia, "
						+ " CASE WHEN (TempoPausas = 0 or TempoPausas is null) and  TempoTotalPausa >0 THEN TempoTotalPausa ELSE TempoPausas END TempoPausas "
						...
						+ " TempoPausas /*/COUNT(proref) OVER(PARTITION BY COD_FUNCIONARIO,datdeb,heudeb)*/  as TempoPausas,TempoTotalPausa "
