...
public class QUA_MC_GABARITOSDao extends GenericDaoJpaImpl<QUA_MC_GABARITOS, Integer>
	...
	public List<Object[]> getlista() {
		String sql =
			...
			" CASE WHEN a.OBSOLETO = 0 AND (lvp.DATA_VERIFICACAO IS NULL OR DATEADD(MONTH, a.FREQ_VERIFICACAO_MESES, lvp.DATA_VERIFICACAO) < GETDATE()) THEN 1 ELSE 0 END AS C14, a.REFERENCIA AS C15 " +
			...
			"ORDER BY a.CODIGO_GABARITO DESC";
