...
public class AB_DIC_BANHO_COMPONENTEDao extends GenericDaoJpaImpl<AB_DIC_BANHO_COMPONENTE,Integer> implements GenericDao<AB_DIC_BANHO_COMPONENTE,Integer> {
	...
	public List<AB_DIC_BANHO_COMPONENTE> getbyid_banho(Integer id) {
		...
		Query query = entityManager.createQuery("Select a,b,"
				...
				+ "where  a.ID_COMPONENTE = b.ID_COMPONENTE  and a.ID_BANHO = :id and a.INATIVO != 1 and (a.DATA_FIM >= GETDATE() or a.DATA_FIM is null)  and a.DATA_INICIO <= GETDATE() "
