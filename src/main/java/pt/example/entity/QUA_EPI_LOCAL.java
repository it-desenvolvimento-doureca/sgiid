...
/**
 * Locais EPI: quais dos GER_LOCAIS da empresa são locais de entrega e
 * levantamento de EPI. É só uma seleção - o local em si continua a viver
 * em GER_LOCAIS (o mesmo que RH_SECTORES.local usa).
 */
@Entity
@Table(name = "QUA_EPI_LOCAL")
public class QUA_EPI_LOCAL {
	@Id
