...
@Entity
@Table(name = "QUA_MC_DERROGACOES_FICHEIROS")
public class QUA_MC_DERROGACOES_FICHEIROS {
	@Id
	...
	@JsonProperty("CAMINHO") private String CAMINHO;
	@JsonProperty("TIPO") private String TIPO;
	@JsonProperty("DATATYPE") private String DATATYPE;
	@JsonProperty("TAMANHO") private Integer TAMANHO;
	@JsonProperty("FICHEIRO_1") private String FICHEIRO_1;
	@JsonProperty("FICHEIRO_2") private String FICHEIRO_2;
	...
	public Integer getTAMANHO() { return TAMANHO; } public void setTAMANHO(Integer v) { TAMANHO = v; }
	public String getFICHEIRO_1() { return FICHEIRO_1; } public void setFICHEIRO_1(String v) { FICHEIRO_1 = v; }
	public String getFICHEIRO_2() { return FICHEIRO_2; } public void setFICHEIRO_2(String v) { FICHEIRO_2 = v; }
