...
@Entity
@Table(name = "QUA_MC_DIC_SECCOES")
public class QUA_MC_DIC_SECCOES {
	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@JsonProperty("ID_SECCAO")
	private Integer ID_SECCAO;
	@JsonProperty("LOCAL_SECCAO")
	private String LOCAL_SECCAO;
	...
	public String getLOCAL_SECCAO() { return LOCAL_SECCAO; }
	public void setLOCAL_SECCAO(String v) { LOCAL_SECCAO = v; }
