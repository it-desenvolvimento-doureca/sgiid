...
public class GER_PARAMETROS {
	...
	private Integer ATUALIZACAO_SILVER_BI_DIA_DA_SEMANA;
	private String ATUALIZACAO_SILVER_BI_HORAS;
	...
	@Column(name = "ATUALIZACAO_SILVER_BI_DIA_DA_SEMANA")
	public Integer getATUALIZACAO_SILVER_BI_DIA_DA_SEMANA() {
		return ATUALIZACAO_SILVER_BI_DIA_DA_SEMANA;
	}

	@Column(name = "ATUALIZACAO_SILVER_BI_HORAS")
	public String getATUALIZACAO_SILVER_BI_HORAS() {
		return ATUALIZACAO_SILVER_BI_HORAS;
	}
	...
	public void setATUALIZACAO_SILVER_BI_DIA_DA_SEMANA(Integer aTUALIZACAO_SILVER_BI_DIA_DA_SEMANA) {
		ATUALIZACAO_SILVER_BI_DIA_DA_SEMANA = aTUALIZACAO_SILVER_BI_DIA_DA_SEMANA;
	}

	public void setATUALIZACAO_SILVER_BI_HORAS(String aTUALIZACAO_SILVER_BI_HORAS) {
		ATUALIZACAO_SILVER_BI_HORAS = aTUALIZACAO_SILVER_BI_HORAS;
	}
