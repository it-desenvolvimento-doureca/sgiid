...
public class GER_PARAMETROS {
	...
	private Integer TEMPO_PLANEADAS_PINTURA;
	private Integer TEMPO_MAX_PLANEADAS_PINTURA;
	...
	@Column(name = "TEMPO_PLANEADAS_PINTURA")
	public Integer getTEMPO_PLANEADAS_PINTURA() {
		return TEMPO_PLANEADAS_PINTURA;
	}

	@Column(name = "TEMPO_MAX_PLANEADAS_PINTURA")
	public Integer getTEMPO_MAX_PLANEADAS_PINTURA() {
		return TEMPO_MAX_PLANEADAS_PINTURA;
	}

	public void setTEMPO_PLANEADAS_PINTURA(Integer tEMPO_PLANEADAS_PINTURA) {
		TEMPO_PLANEADAS_PINTURA = tEMPO_PLANEADAS_PINTURA;
	}

	public void setTEMPO_MAX_PLANEADAS_PINTURA(Integer tEMPO_MAX_PLANEADAS_PINTURA) {
		TEMPO_MAX_PLANEADAS_PINTURA = tEMPO_MAX_PLANEADAS_PINTURA;
	}
