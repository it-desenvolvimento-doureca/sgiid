...
public class PIN_MOV_RECEITAS_LINHAS {
    ...
    @JsonProperty("CONSUMO_CARGA_COR")
    private Float CONSUMO_CARGA_COR;
    @JsonProperty("CONSUMO_CARGA_CATALISADOR")
    private Float CONSUMO_CARGA_CATALISADOR;
    ...
    @JsonProperty("PRESSAO_ENTRADA")
	private String PRESSAO_ENTRADA;
    @JsonProperty("PRESSAO_RETORNO")
	private String PRESSAO_RETORNO;
	...
	public Float getCONSUMO_CARGA_COR() {
		return CONSUMO_CARGA_COR;
	}

	public Float getCONSUMO_CARGA_CATALISADOR() {
		return CONSUMO_CARGA_CATALISADOR;
	}
	...
	public void setCONSUMO_CARGA_COR(Float cONSUMO_CARGA_COR) {
		CONSUMO_CARGA_COR = cONSUMO_CARGA_COR;
	}

	public void setCONSUMO_CARGA_CATALISADOR(Float cONSUMO_CARGA_CATALISADOR) {
		CONSUMO_CARGA_CATALISADOR = cONSUMO_CARGA_CATALISADOR;
	}
	...
	public String getDILUENTE2_C() {
		return DILUENTE2_C;
	}

	public String getDILUENTE3_C() {
		return DILUENTE3_C;
	}

	public String getDILUENTE4_C() {
		return DILUENTE4_C;
	}

	public String getDILUENTE5_C() {
		return DILUENTE5_C;
	}

	public Float getQTD_RACK_REFERENCIA2_C() {
		return QTD_RACK_REFERENCIA2_C;
	}

	public Float getQTD_RACK_REFERENCIA3_C() {
		return QTD_RACK_REFERENCIA3_C;
	}

	public Float getQTD_RACK_REFERENCIA4_C() {
		return QTD_RACK_REFERENCIA4_C;
	}

	public Float getQTD_RACK_REFERENCIA5_C() {
		return QTD_RACK_REFERENCIA5_C;
	}

	public Float getNECESSIDADES_RACK_REFERENCIA2_C() {
		return NECESSIDADES_RACK_REFERENCIA2_C;
	}

	public Float getNECESSIDADES_RACK_REFERENCIA3_C() {
		return NECESSIDADES_RACK_REFERENCIA3_C;
	}

	public Float getNECESSIDADES_RACK_REFERENCIA4_C() {
		return NECESSIDADES_RACK_REFERENCIA4_C;
	}

	public Float getNECESSIDADES_RACK_REFERENCIA5_C() {
		return NECESSIDADES_RACK_REFERENCIA5_C;
	}

	public String getPRESSAO_ENTRADA() {
		return PRESSAO_ENTRADA;
	}

	public String getPRESSAO_RETORNO() {
		return PRESSAO_RETORNO;
	}
	...
	public void setDILUENTE2_C(String dILUENTE2_C) {
		DILUENTE2_C = dILUENTE2_C;
	}

	public void setDILUENTE3_C(String dILUENTE3_C) {
		DILUENTE3_C = dILUENTE3_C;
	}

	public void setDILUENTE4_C(String dILUENTE4_C) {
		DILUENTE4_C = dILUENTE4_C;
	}

	public void setDILUENTE5_C(String dILUENTE5_C) {
		DILUENTE5_C = dILUENTE5_C;
	}

	public void setQTD_RACK_REFERENCIA2_C(Float qTD_RACK_REFERENCIA2_C) {
		QTD_RACK_REFERENCIA2_C = qTD_RACK_REFERENCIA2_C;
	}

	public void setQTD_RACK_REFERENCIA3_C(Float qTD_RACK_REFERENCIA3_C) {
		QTD_RACK_REFERENCIA3_C = qTD_RACK_REFERENCIA3_C;
	}

	public void setQTD_RACK_REFERENCIA4_C(Float qTD_RACK_REFERENCIA4_C) {
		QTD_RACK_REFERENCIA4_C = qTD_RACK_REFERENCIA4_C;
	}

	public void setQTD_RACK_REFERENCIA5_C(Float qTD_RACK_REFERENCIA5_C) {
		QTD_RACK_REFERENCIA5_C = qTD_RACK_REFERENCIA5_C;
	}

	public void setNECESSIDADES_RACK_REFERENCIA2_C(Float nECESSIDADES_RACK_REFERENCIA2_C) {
		NECESSIDADES_RACK_REFERENCIA2_C = nECESSIDADES_RACK_REFERENCIA2_C;
	}

	public void setNECESSIDADES_RACK_REFERENCIA3_C(Float nECESSIDADES_RACK_REFERENCIA3_C) {
		NECESSIDADES_RACK_REFERENCIA3_C = nECESSIDADES_RACK_REFERENCIA3_C;
	}

	public void setNECESSIDADES_RACK_REFERENCIA4_C(Float nECESSIDADES_RACK_REFERENCIA4_C) {
		NECESSIDADES_RACK_REFERENCIA4_C = nECESSIDADES_RACK_REFERENCIA4_C;
	}

	public void setNECESSIDADES_RACK_REFERENCIA5_C(Float nECESSIDADES_RACK_REFERENCIA5_C) {
		NECESSIDADES_RACK_REFERENCIA5_C = nECESSIDADES_RACK_REFERENCIA5_C;
	}

	public void setPRESSAO_ENTRADA(String pRESSAO_ENTRADA) {
		PRESSAO_ENTRADA = pRESSAO_ENTRADA;
	}

	public void setPRESSAO_RETORNO(String pRESSAO_RETORNO) {
		PRESSAO_RETORNO = pRESSAO_RETORNO;
	}
