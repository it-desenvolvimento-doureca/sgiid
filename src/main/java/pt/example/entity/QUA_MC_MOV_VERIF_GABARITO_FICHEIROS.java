...
@Entity
@Table(name = "QUA_MC_MOV_VERIF_GABARITO_FICHEIROS")
public class QUA_MC_MOV_VERIF_GABARITO_FICHEIROS {
	@Id
	...
	public String getTIPO_ANEXO() { return TIPO_ANEXO; }
	public void setTIPO_ANEXO(String v) { TIPO_ANEXO = v; }
