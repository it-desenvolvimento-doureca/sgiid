...
@Entity
@Table(name = "RH_DIC_AREA_FORMACAO")
public class RH_DIC_AREA_FORMACAO {
	@Id
	...
	public Integer getDIAS_VALIDADE() {
	...
	public void setDIAS_VALIDADE(Integer dIAS_VALIDADE) {
