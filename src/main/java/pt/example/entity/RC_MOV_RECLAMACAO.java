...
public class RC_MOV_RECLAMACAO {
	...
	private Integer NUMERO_ENVIOS_GARANTIDOS;

	private String ENVIO_GARANTIDO_POR;

	private Integer DIAS_ATRASO1;
	private String RESPONSABILIDADE_ATRASO1;
	private String RESPONSABILIDADE_ATRASO1_DESCRICAO;

	private Integer DIAS_ATRASO2;
	private String RESPONSABILIDADE_ATRASO2;
	private String RESPONSABILIDADE_ATRASO2_DESCRICAO;

	private Integer DIAS_ATRASO3;
	private String RESPONSABILIDADE_ATRASO3;
	private String RESPONSABILIDADE_ATRASO3_DESCRICAO;

	private Integer DIAS_ATRASO4;
	private String RESPONSABILIDADE_ATRASO4;
	private String RESPONSABILIDADE_ATRASO4_DESCRICAO;

	private Integer DIAS_ATRASO5;
	private String RESPONSABILIDADE_ATRASO5;
	private String RESPONSABILIDADE_ATRASO5_DESCRICAO;

	private Integer DIAS_ATRASO6;
	private String RESPONSABILIDADE_ATRASO6;
	private String RESPONSABILIDADE_ATRASO6_DESCRICAO;

	private Integer DIAS_ATRASO7;
	private String RESPONSABILIDADE_ATRASO7;
	private String RESPONSABILIDADE_ATRASO7_DESCRICAO;

	private Integer DIAS_ATRASO8;
	...
	private String FICHEIRO_PRODUCAO_NOME;
	private String FICHEIRO_PRODUCAO_1;
	private String FICHEIRO_PRODUCAO_2;
	private String OPERARIOS_ENVOLVIDOS;
	...
	@Column(name = "NUMERO_ENVIOS_GARANTIDOS")
	public Integer getNUMERO_ENVIOS_GARANTIDOS() {
		return NUMERO_ENVIOS_GARANTIDOS;
	}

	public void setNUMERO_ENVIOS_GARANTIDOS(Integer nUMERO_ENVIOS_GARANTIDOS) {
		NUMERO_ENVIOS_GARANTIDOS = nUMERO_ENVIOS_GARANTIDOS;
	}
	...
	@Column(name = "DIAS_ATRASO1")
	public Integer getDIAS_ATRASO1() {
		return DIAS_ATRASO1;
	}

	@Column(name = "RESPONSABILIDADE_ATRASO1")
	public String getRESPONSABILIDADE_ATRASO1() {
		return RESPONSABILIDADE_ATRASO1;
	}

	@Column(name = "RESPONSABILIDADE_ATRASO1_DESCRICAO")
	public String getRESPONSABILIDADE_ATRASO1_DESCRICAO() {
		return RESPONSABILIDADE_ATRASO1_DESCRICAO;
	}

	@Column(name = "DIAS_ATRASO2")
	public Integer getDIAS_ATRASO2() {
		return DIAS_ATRASO2;
	}

	@Column(name = "RESPONSABILIDADE_ATRASO2")
	public String getRESPONSABILIDADE_ATRASO2() {
		return RESPONSABILIDADE_ATRASO2;
	}

	@Column(name = "RESPONSABILIDADE_ATRASO2_DESCRICAO")
	public String getRESPONSABILIDADE_ATRASO2_DESCRICAO() {
		return RESPONSABILIDADE_ATRASO2_DESCRICAO;
	}

	@Column(name = "DIAS_ATRASO3")
	public Integer getDIAS_ATRASO3() {
		return DIAS_ATRASO3;
	}

	@Column(name = "RESPONSABILIDADE_ATRASO3")
	public String getRESPONSABILIDADE_ATRASO3() {
		return RESPONSABILIDADE_ATRASO3;
	}

	@Column(name = "RESPONSABILIDADE_ATRASO3_DESCRICAO")
	public String getRESPONSABILIDADE_ATRASO3_DESCRICAO() {
		return RESPONSABILIDADE_ATRASO3_DESCRICAO;
	}

	@Column(name = "DIAS_ATRASO5")
	public Integer getDIAS_ATRASO5() {
		return DIAS_ATRASO5;
	}

	@Column(name = "RESPONSABILIDADE_ATRASO5")
	public String getRESPONSABILIDADE_ATRASO5() {
		return RESPONSABILIDADE_ATRASO5;
	}

	@Column(name = "RESPONSABILIDADE_ATRASO5_DESCRICAO")
	public String getRESPONSABILIDADE_ATRASO5_DESCRICAO() {
		return RESPONSABILIDADE_ATRASO5_DESCRICAO;
	}

	@Column(name = "DIAS_ATRASO7")
	public Integer getDIAS_ATRASO7() {
		return DIAS_ATRASO7;
	}

	@Column(name = "RESPONSABILIDADE_ATRASO7")
	public String getRESPONSABILIDADE_ATRASO7() {
		return RESPONSABILIDADE_ATRASO7;
	}

	@Column(name = "RESPONSABILIDADE_ATRASO7_DESCRICAO")
	public String getRESPONSABILIDADE_ATRASO7_DESCRICAO() {
		return RESPONSABILIDADE_ATRASO7_DESCRICAO;
	}

	@Column(name = "DIAS_ATRASO8")
	public Integer getDIAS_ATRASO8() {
		return DIAS_ATRASO8;
	}

	@Column(name = "RESPONSABILIDADE_ATRASO8")
	public String getRESPONSABILIDADE_ATRASO8() {
		return RESPONSABILIDADE_ATRASO8;
	}

	@Column(name = "RESPONSABILIDADE_ATRASO8_DESCRICAO")
	public String getRESPONSABILIDADE_ATRASO8_DESCRICAO() {
		return RESPONSABILIDADE_ATRASO8_DESCRICAO;
	}

	public void setDIAS_ATRASO1(Integer dIAS_ATRASO1) {
		DIAS_ATRASO1 = dIAS_ATRASO1;
	}

	public void setRESPONSABILIDADE_ATRASO1(String rESPONSABILIDADE_ATRASO1) {
		RESPONSABILIDADE_ATRASO1 = rESPONSABILIDADE_ATRASO1;
	}

	public void setRESPONSABILIDADE_ATRASO1_DESCRICAO(String rESPONSABILIDADE_ATRASO1_DESCRICAO) {
		RESPONSABILIDADE_ATRASO1_DESCRICAO = rESPONSABILIDADE_ATRASO1_DESCRICAO;
	}

	public void setDIAS_ATRASO2(Integer dIAS_ATRASO2) {
		DIAS_ATRASO2 = dIAS_ATRASO2;
	}

	public void setRESPONSABILIDADE_ATRASO2(String rESPONSABILIDADE_ATRASO2) {
		RESPONSABILIDADE_ATRASO2 = rESPONSABILIDADE_ATRASO2;
	}

	public void setRESPONSABILIDADE_ATRASO2_DESCRICAO(String rESPONSABILIDADE_ATRASO2_DESCRICAO) {
		RESPONSABILIDADE_ATRASO2_DESCRICAO = rESPONSABILIDADE_ATRASO2_DESCRICAO;
	}

	public void setDIAS_ATRASO3(Integer dIAS_ATRASO3) {
		DIAS_ATRASO3 = dIAS_ATRASO3;
	}

	public void setRESPONSABILIDADE_ATRASO3(String rESPONSABILIDADE_ATRASO3) {
		RESPONSABILIDADE_ATRASO3 = rESPONSABILIDADE_ATRASO3;
	}

	public void setRESPONSABILIDADE_ATRASO3_DESCRICAO(String rESPONSABILIDADE_ATRASO3_DESCRICAO) {
		RESPONSABILIDADE_ATRASO3_DESCRICAO = rESPONSABILIDADE_ATRASO3_DESCRICAO;
	}

	public void setDIAS_ATRASO5(Integer dIAS_ATRASO5) {
		DIAS_ATRASO5 = dIAS_ATRASO5;
	}

	public void setRESPONSABILIDADE_ATRASO5(String rESPONSABILIDADE_ATRASO5) {
		RESPONSABILIDADE_ATRASO5 = rESPONSABILIDADE_ATRASO5;
	}

	public void setRESPONSABILIDADE_ATRASO5_DESCRICAO(String rESPONSABILIDADE_ATRASO5_DESCRICAO) {
		RESPONSABILIDADE_ATRASO5_DESCRICAO = rESPONSABILIDADE_ATRASO5_DESCRICAO;
	}

	public void setDIAS_ATRASO7(Integer dIAS_ATRASO7) {
		DIAS_ATRASO7 = dIAS_ATRASO7;
	}

	public void setRESPONSABILIDADE_ATRASO7(String rESPONSABILIDADE_ATRASO7) {
		RESPONSABILIDADE_ATRASO7 = rESPONSABILIDADE_ATRASO7;
	}

	public void setRESPONSABILIDADE_ATRASO7_DESCRICAO(String rESPONSABILIDADE_ATRASO7_DESCRICAO) {
		RESPONSABILIDADE_ATRASO7_DESCRICAO = rESPONSABILIDADE_ATRASO7_DESCRICAO;
	}

	public void setDIAS_ATRASO8(Integer dIAS_ATRASO8) {
		DIAS_ATRASO8 = dIAS_ATRASO8;
	}

	public void setRESPONSABILIDADE_ATRASO8(String rESPONSABILIDADE_ATRASO8) {
		RESPONSABILIDADE_ATRASO8 = rESPONSABILIDADE_ATRASO8;
	}

	public void setRESPONSABILIDADE_ATRASO8_DESCRICAO(String rESPONSABILIDADE_ATRASO8_DESCRICAO) {
		RESPONSABILIDADE_ATRASO8_DESCRICAO = rESPONSABILIDADE_ATRASO8_DESCRICAO;
	}
	...
	@Column(name = "ENVIO_GARANTIDO_POR")
	public String getENVIO_GARANTIDO_POR() {
		return ENVIO_GARANTIDO_POR;
	}
	...
	@Column(name = "FICHEIRO_PRODUCAO_NOME")
	public String getFICHEIRO_PRODUCAO_NOME() {
		return FICHEIRO_PRODUCAO_NOME;
	}

	@Column(name = "FICHEIRO_PRODUCAO_1")
	public String getFICHEIRO_PRODUCAO_1() {
		return FICHEIRO_PRODUCAO_1;
	}

	@Column(name = "FICHEIRO_PRODUCAO_2")
	public String getFICHEIRO_PRODUCAO_2() {
		return FICHEIRO_PRODUCAO_2;
	}

	@Column(name = "OPERARIOS_ENVOLVIDOS")
	public String getOPERARIOS_ENVOLVIDOS() {
		return OPERARIOS_ENVOLVIDOS;
	}

	public void setFICHEIRO_PRODUCAO_NOME(String fICHEIRO_PRODUCAO_NOME) {
		FICHEIRO_PRODUCAO_NOME = fICHEIRO_PRODUCAO_NOME;
	}

	public void setFICHEIRO_PRODUCAO_1(String fICHEIRO_PRODUCAO_1) {
		FICHEIRO_PRODUCAO_1 = fICHEIRO_PRODUCAO_1;
	}

	public void setFICHEIRO_PRODUCAO_2(String fICHEIRO_PRODUCAO_2) {
		FICHEIRO_PRODUCAO_2 = fICHEIRO_PRODUCAO_2;
	}

	public void setOPERARIOS_ENVOLVIDOS(String oPERARIOS_ENVOLVIDOS) {
		OPERARIOS_ENVOLVIDOS = oPERARIOS_ENVOLVIDOS;
	}
