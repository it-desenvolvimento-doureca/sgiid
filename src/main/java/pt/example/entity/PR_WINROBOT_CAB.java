...
public class PR_WINROBOT_CAB
{
    ...
    private Integer NUMERO_IDENTICACAO_CARGA;
	...
	public Integer getNUMERO_IDENTICACAO_CARGA() {
	...
	public void setNUMERO_IDENTICACAO_CARGA(Integer nUMERO_IDENTICACAO_CARGA) {
