...
/**
 * Famílias de EPI aplicáveis a cada sector.
 * Alimenta as linhas do separador EPI's da ficha do funcionário:
 * RH_FUNCIONARIOS.COD_SECTOR -> famílias -> escolha de EPI/tamanho.
 */
@Entity
@Table(name = "RH_SECTORES_EPI_FAMILIA")
public class RH_SECTORES_EPI_FAMILIA {
	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@JsonProperty("ID")
	private Integer ID;
	// FK -> RH_SECTORES.COD_SECTOR
